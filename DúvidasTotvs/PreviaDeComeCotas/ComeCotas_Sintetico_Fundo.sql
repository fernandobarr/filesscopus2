...
DECLARE @Data01 date =  '2015-10-29 00:00:00.000' 
,@Empresa char (15) =  'EMP0001' 
,@Fundo char (15) =  '007232'   

SELECT COT_FUNDO.CD_FUNDO,
       COT_CLIENTE_FUNDO.NM_CLIENTE NM_FUNDO,
       COT_FUNDO.CD_GESTOR,
       COT_CLIENTE_GESTOR.NM_CLIENTE NM_GESTOR,
       COT_FUNDO.CD_ADMINISTRADOR,
       COT_CLIENTE_ADMINISTRADOR.NM_CLIENTE NM_ADMINISTRADOR,
 ...
 WHERE COT_POSICAO_FUNDO.IC_AF_POSICAO = 'A'
   ...
   AND COT_FUNDO.CD_FUNDO IN(  @Fundo   )
