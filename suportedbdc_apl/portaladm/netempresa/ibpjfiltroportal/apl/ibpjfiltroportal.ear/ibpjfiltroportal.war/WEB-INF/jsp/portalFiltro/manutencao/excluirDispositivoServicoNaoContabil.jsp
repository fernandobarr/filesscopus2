...
<html:form action="/ConfirmarExcluirNaoContabil" method="post" >
...
<table width="60%" align="center" border="0" id="tabela_dados">
	<tbody>
		...
		<logic:iterate name="manutencaoAdministrativoForm" property="listaServicoSelecionado" id="parametrizacaoServico">
			<tr height="20">
