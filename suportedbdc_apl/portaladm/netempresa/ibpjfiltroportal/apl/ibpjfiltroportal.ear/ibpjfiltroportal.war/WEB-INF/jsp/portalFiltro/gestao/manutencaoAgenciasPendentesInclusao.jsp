	...
	<tbody>
		<tr>
			<td>
				...
				<html:link action="AprovarReprovarIntervaloAgencias" paramId="CTRL" paramName="CTRL" style="padding: 0 5px;">
					<img src="<nedc:estaticpath path="bt_aprovar.gif" type="imagem" />" border="0">
				</html:link> 
				<html:link action="AprovarReprovarIntervaloAgencias" paramId="CTRL" paramName="CTRL" style="padding-left: 5px;">
