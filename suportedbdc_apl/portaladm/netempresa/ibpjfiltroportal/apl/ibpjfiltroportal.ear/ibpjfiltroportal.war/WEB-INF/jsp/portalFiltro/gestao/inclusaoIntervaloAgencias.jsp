...
<script>
var msgIntervaloDe = "O campo Da Agência é obrigatório.";
var msgIntervaloAte = "O campo Até Agência é obrigatório.";
</script>
...
<html:form action="InclusaoIntervaloAgencias" method="post">
...
<html:hidden name="criacaoClientesForm" property="listaAgencias" styleClass="listaIntervalos"/>
	...
	<tbody>
		...
		<tr id="linha_vazia" style="display: none;">
			<td align="center" bgcolor="#ebebeb" class="textos">
				Da Agência: <input size="4" type="text" class="numeric input_de"/>
			</td>
			<td bgcolor="#ebebeb" class="textos">
				Até Agência: <input size="4" type="text" class="numeric input_ate"/>
			</td>
			<td align="right">
