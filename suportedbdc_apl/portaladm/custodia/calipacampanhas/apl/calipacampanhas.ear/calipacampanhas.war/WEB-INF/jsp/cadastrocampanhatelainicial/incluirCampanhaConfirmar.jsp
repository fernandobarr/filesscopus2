...
function VrfFrm(form) {
	...
	if(!VrfApplet(0)) {
		...
		document.forms[0].action = "IncluirCampanhaEfetivar.do";
		form.submit();
		return;
	}
}
	...
	<table class="tabelaDadosPortal">
		...
		<tbody>
			...
			<tr>
				...
				<td>
				<%--
					<bean:write name="campanhaForm" property="conteudoImagem.enFisicoConteudoCampanha"/><br/>
					<bean:write name="campanhaForm" property="conteudoImagem.enURLConteudoCampanha"/><br/>
				 --%>
