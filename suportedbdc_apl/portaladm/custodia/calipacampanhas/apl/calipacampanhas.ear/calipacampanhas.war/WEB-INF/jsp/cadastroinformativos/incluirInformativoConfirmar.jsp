...
<!--
function voltar() {
	document.forms[0].action = 'IncluirCampanhaEntrada.do?CTRL=' + '<%=request.getParameter("CTRL")%>';
...
function VrfFrm(form) {
	...
	if(!VrfApplet(0)) {
		...
		document.forms[0].action = "IncluirInformativoEfetivar.do";
		form.submit();
		return;
	}
}
	...
	<table class="tabelaDadosPortal">
		...
		<tbody>
			...
			<tr>
				...
				<logic:present name="campanhaForm" property="campanha.categoriaInformativo.nmCategoriaInformativo"> - <bean:write name="campanhaForm" property="campanha.categoriaInformativo.nmCategoriaInformativo"/></logic:present>
				</td>
			</tr>
			<tr>
				<td>Arquivo:</td>
				<td>
					...
					<bean:write name="campanhaForm" property="conteudoImagem.nomeArquivo"/>
					</a>
				</td>
			</tr>
			<tr>
